...
router.get('/eligibility-course', (req, res) => {	
	...
	req.session.data['course-id'] = ''

	res.render(`${req.version}/eligibility-course`)
})

router.post('/eligibility-course', (req, res) => {	
	// req.session.data['reservation']['course-name'] = req.session.data['course-name'].split("*")[1]
	req.session.data['course-id'] = req.session.data['course-name'].split("*")[0]
...
router.post('/eligibility-provider', (req, res) => {	
	if (req.session.data['eligibility-provider'] == 'yes'){
		res.redirect('task--apprentice-details/permission')
	} else {
...
router.post('/eligibility-start-date', (req, res) => {
	...
	if (req.session.data['reservation']['start-month'] != 'unknown'){
		res.redirect('eligibility-reservation-details')
	} else {
		req.session.data['reservation'] = {}
		delete req.session.data['reservation']
...
router.post('/eligibility-reservation-details', (req, res) => {
	res.redirect('eligibility-reserved')
})

router.post('/eligibility-recruit', (req, res) => {
	delete req.session.data['reservation']
	req.session.data['reservation'] = {}
	res.redirect('eligibility-course')
})
