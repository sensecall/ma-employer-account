...
// change provider
router.post('/choose-existing-training-provider', (req, res) => {
	res.redirect('choose-new-training-provider')
})

router.post('/stopped-check', (req, res) => {
	if(req.session.data['stopped-check'] == 'true'){
		res.redirect('choose-new-training-provider')
	} else {
		res.redirect('stopped-error')
	}
})

router.post('/choose-new-training-provider', (req, res) => {
...
router.post('/new-start-date', (req, res) => {
	res.redirect('new-end-date')
})

router.post('/new-end-date', (req, res) => {
	res.redirect('new-price')
})

router.post('/new-price', (req, res) => {
